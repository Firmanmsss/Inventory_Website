...
type="button" data-toggle="dropdown" aria-haspopup="true" onclick="window.location.href='{{ route('category.create') }}'" aria-expanded="false">Tambah</button>
@endsection
<!-- isi bagian konten -->
@section('contents')
    ...
    $('#ReadTable').DataTable({
      ...
      dom: 'Bfrtip',
        buttons: [
          ...
          {extend:'csv'},
          {extend: 'excel', title: 'Contoh File Excel List Category'},
          {extend: 'pdf', title:'Contoh File PDF List Category'},
          {extend:'print',title: 'Contoh Print List Category'},
          {
