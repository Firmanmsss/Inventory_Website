      ...
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">Inventory</span></a>
          <ul class="menu-content">
            ...
            <li><a class="menu-item" href="#" data-i18n="nav.templates.horz.main">Rack Location</a>
              <ul class="menu-content">
        ...
        <li class=" nav-item"><a href="#"><i class="la la-shopping-cart"></i><span class="menu-title" data-i18n="nav.dash.main">Transaction</span></a>
          <ul class="menu-content">
            <li class=" navigation-header">
              <span>Good Receipt</span><i class="la la-ellipsis-h ft-minus" data-toggle="tooltip" data-placement="right" data-original-title="Transaksi"></i>
            </li>
            ...
            <li class=" navigation-header">
              <span>Good Issue</span><i class="la la-ellipsis-h ft-minus" data-toggle="tooltip" data-placement="right" data-original-title="Transaksi"></i>
            </li>
