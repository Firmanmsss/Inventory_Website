...
<li class="breadcrumb-item active">List Checker
</li>
...
type="button" data-toggle="dropdown" aria-haspopup="true" onclick="window.location.href='{{ route('checker.create') }}'" aria-expanded="false">Tambah</button>
@endsection
<!-- isi bagian konten -->
@section('contents')
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">List Checker</h4>
    ...
    $('#ReadTable').DataTable({
      ...
      dom: 'Bfrtip',
        buttons: [
          ...
          {extend:'csv'},
          {extend: 'excel', title: 'Contoh File Excel List Checker'},
          {extend: 'pdf', title:'Contoh File PDF List Checker'},
          {extend:'print',title: 'Contoh Print List Checker'},
          {
