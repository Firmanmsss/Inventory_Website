...
<li class="breadcrumb-item active">List Location
</li>
...
type="button" data-toggle="dropdown" aria-haspopup="true" onclick="window.location.href='{{ route('locat.create') }}'" aria-expanded="false">Tambah</button>
@endsection
<!-- isi bagian konten -->
@section('contents')
    ...
    $('#ReadTable').DataTable({
      ...
      dom: 'Bfrtip',
        buttons: [
          ...
          {extend: 'csv'},
          {extend: 'excel', title: 'Contoh File Excel List Location'},
          {extend: 'pdf', title:'Contoh File PDF List Location'},
          {extend: 'print',title: 'Contoh Print List Location'},
          {
