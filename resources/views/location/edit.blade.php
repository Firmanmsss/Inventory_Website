        ...
        <div class="card">
          ...
          <div class="card-content collapse show">
            <div class="card-body">
              ...
              @endif
              <form class="form" novalidate action="{{ route('locat.update', $item->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="location_name" value="{{ $item->location_name }}" class="form-control" placeholder="Location Name" name="location_name">
                      </div>
                    </div>
                  </div>
                </div>
