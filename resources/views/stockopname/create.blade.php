...
<li class="breadcrumb-item active">Create Stock Opname
</li>
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-content collapse show">
            ...
            @endif
              <form class="form" id="validateform" action="{{ route('stockopname.store') }}" method="POST">
                @csrf
                <div class="form-body">
                  <h4 class="form-section"><i class="ft-user"></i> Data Stock Opname</h4>
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="form-actions">
                  <button type="button" class="btn btn-warning mr-1" onclick="window.location.href='{{ route('stockopname.index') }}'">
