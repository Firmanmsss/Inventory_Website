...
<li class="breadcrumb-item active">List Unit
</li>
...
type="button" data-toggle="dropdown" aria-haspopup="true" onclick="window.location.href='{{ route('satuan.create') }}'" aria-expanded="false">Tambah</button>
@endsection
<!-- isi bagian konten -->
@section('contents')
    ...
    $('#ReadTable').DataTable({
      ...
      dom: 'Bfrtip',
        buttons: [
          ...
          {extend:'csv'},
          {extend: 'excel', title: 'Contoh File Excel List Unit'},
          {extend: 'pdf', title:'Contoh File PDF List Unit'},
          {extend:'print',title: 'Contoh Print List Unit'},
          {
