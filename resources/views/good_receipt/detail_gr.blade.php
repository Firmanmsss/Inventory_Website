...
<script>
    $(document).ready(function(){
        ...
        buttons: [
          ...
          {extend:'csv'},
          {extend: 'excel', title: 'Contoh File Excel Detail Good Receipt'},
          {extend: 'pdf', title:'Contoh File PDF Detail Good Receipt'},
          {extend:'print',title: 'Contoh Print Detail Good Receipt'},
          {
